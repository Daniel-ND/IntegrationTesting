...
@DisplayName("Cosecont integration")
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
public class CosecontIntegration {
    ...
    @ParameterizedTest
    @ValueSource(doubles = {-Math.PI, -1.75, -Math.PI/2, -0.5,-1,-2, 0.0, 0.5, 1.0, 1.5})
    ...
    public void tearDown(){
        try {
            CSVWriter.printToFile(function,-5.0, 0.1, 100, "cosecontIntegration");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
